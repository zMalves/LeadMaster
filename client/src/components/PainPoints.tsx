export default function PainPoints() {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "hsl(var(--support))" }}
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 fade-in">
          ...
          <p className="text-xl text-gray-600">
            Reconhece alguns destes desafios no seu dia a dia?
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {painPoints.map((point, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 card-hover fade-in"
            >
              ...
              <h3 className="font-bold text-xl mb-3 text-primary leading-tight">
                {point.title}
              </h3>
